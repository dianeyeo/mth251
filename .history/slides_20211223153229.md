...
Local scope: The names that you define in this scope are only available or visible to the code within the scope. is the code block or body of any Python function or lambda expression.
