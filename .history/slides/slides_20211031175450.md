...
<div class="inline-grid grid-cols-[2fr,3fr] gap-8">
  <div align="left" class="norm">
    <ul>
      <li><span class="hl-color">Perfect Binary Tree</span>: every node has two child nodes except leaf and all leaves on same level, 2^h -1</li>   
      <li>Max 2 child nodes</li>
      <li>One and only one path from root to each node</li>  
      <li>Max nodes on level: 2^l </li>
      <li>Max nodes total: 2^(h+1) - 1</li>  
    </ul>
  </div>  
  <div align="left">
