...
<div class="norm">
  <ul>
    ...
    <li><strong>dequeue(): delete the element</li>
    <li><strong>front(): return the first element in the queue, if queue is empty, return None</li>
    <li><strong>rear(): return the last element in the queue, if queue is empty, return None</li>
    <li><strong>is_empty(): return true if queue is empty</li>
    <li><strong>is_full(): return true if queue is full</li>
  </ul>
</div>
