...
<div class="norm">
  <ul>
    ...
    <li>dequeue(): delete the element</li>
    <li>front(): return the first element in the queue, if queue is empty, return None</li>
    <li>rear(): return the last element in the queue, if queue is empty, return None</li>
    <li>is_empty(): return true if queue is empty</li>
    <li>is_full(): return true if queue is full</li>
  </ul>
</div>
