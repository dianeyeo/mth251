...
🏃‍♂️learning by doing, implementing from scratch  
🙇🏻‍♂️ problem solving
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p class="norm">
      <ol>
        ...
        <li>Environments → +Create to create a new env (e.g. <strong>mth251</strong>)</li>
        <li>Back to Navigator and switch to your Python env <strong>mth251</strong> from “Application on”</li>
  ...
  <div>
    <p>
        <img src="/images/lab/anaconda_env.png" style="width:50%"/>
    </p>
  </div>  
</div>

<p class="norm">
<i class="far fa-comment-dots"></i> Also possible to create a new environment via command line: <br/>
＞ conda create mth251 python=3.8
</p>
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p class="norm">
      <ol start"4">
        <li>Back to Navigator and switch to your Python env <strong>mth251</strong> from “Application on” dropdown and install Jupyter Notebook</li>
      </ol>
    </p> 
  </div>
  <div>
    <p><img src="/images/lab/anaconda_jupyter.png" style="width:50%"/></p>
  </div>
</div>
