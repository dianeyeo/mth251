...
<div grid="~ cols-2 gap-8">
  <div>
    ...
    <ul>
      <ui>when n = 1, fib(1) = 0</ui>
      <ui>when n = 2, fib(2) = 1</ui>
      <ui>when n > 2, fib(n) = fib(n-1) + fib(n-2)</ui>
    </ul>
  </div>
  <div>
...
<!--
Recursion pattern: recursion includes 2 cases the base case and recursive case
