...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      ...
      <br/>
      <i class="far fa-sticky-note"></i> Also possible to create a new environment via command line: 
    </p> 
    <p style="font-size:0.75rem; font-family: 'Open Sans'">＞conda create mth251 python=3.8</p>
  </div>
  <div>
