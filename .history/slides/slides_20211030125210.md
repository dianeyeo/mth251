...
3.  basic data structure: <span style="font-family:'Open Sans', sans-serif;">array</span>, <span style="font-family:'Open Sans', sans-serif;">stacks</span>, <span style="font-family:'Open Sans', sans-serif;">queues</span>, <span style="font-family:'Open Sans', sans-serif;">list</span>, and <span style="font-family:'Open Sans', sans-serif;">tree</span>
...
<p style="font-size:1.5rem; font-family:'Open Sans', sans-serif;">Programming with Mosh </p>
  
<i class="fab fa-youtube"></i> [Python Tutorial - Python for Beginners [2020]](https://www.youtube.com/watch?v=kqtD5dpn9C8)

<br/>

<p style="font-size:1.5rem; font-family:'Open Sans', sans-serif;">freeCodeCamp</p>
...
# Algorithms & Data Structure Intro
...
<p style="color:#357EC7; font-size:1.5rem; font-family:'Open Sans', sans-serif;">Program = Data Structure + Algorithm </p>
