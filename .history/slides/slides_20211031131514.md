...
In programing, memory allocation is quite complicated because we dont do memory allocation randomly and manually. Usually a background process - Garbage collector (GC) will reclaim memory from programs with very 
