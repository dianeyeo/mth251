...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      ...
      <br/>
      <i class="far fa-sticky-note"></i> Also possible to create a new environment via command line: <br/>
      <span style="font-size:0.75rem; font-family: 'Open Sans'">＞conda create mth251 python=3.8
    </p> 
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      <ol start="3">
        <li>Switch to your Python env mth251 from “Application on” dropdown</li>
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      ...
      <br/>
      <i class="far fa-sticky-note"></i> Notice the Jupyter link in the prompt, you can copy & paste it to your browser.<br/> 
      <i class="far fa-sticky-note"></i> You can Control-C to stop Jupyter from the command line. 
    </p>
  </div>
  <div>
