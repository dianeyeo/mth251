...
<div grid="~ cols-2 gap-10">
  <div><img src="/images/stack_push.png"/></div>
  <div><img src="/images/stack_pop.png" /></div>
</div>
...
-   <span class="hl-color">enqueue</span>() − pushing (storing) an element on the stack
-   <span class="hl-color">dequeue</span>() − removing (accessing) an element from the stack
-   top()/peek() − get the top data element of the stack, without removing it
-   size(), isEmpty(), isFull(), …
