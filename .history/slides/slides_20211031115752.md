...
<img src="/images/array_address.png" style="witdh: 70%">

element type: char  
data_type_size: 2 byte (1 byte = 8 bits, 0000 0000 ~ 1111 1111)  
total_size = array_size _ data_type_size
arr[i].address = base_address + i _ data_type_size <- O(1)
