...
3.  basic data structure: <span style="font-family:'Open Sans', sans-serif;">array</span>, <span style="font-family:'Open Sans', sans-serif;">stacks`, <span style="font-family:'Open Sans', sans-serif;">queues`, <span style="font-family:'Open Sans', sans-serif;">list`, and <span style="font-family:'Open Sans', sans-serif;">tree`
