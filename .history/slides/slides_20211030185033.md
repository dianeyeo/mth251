...
VS Code now fully integrated with Jupyter notebook, refer to this video for setup:

<i class="fab fa-youtube"></i> [Getting Started with Jupyter Notebooks in VS Code](https://www.youtube.com/watch?v=Ozq24uAshXo)
