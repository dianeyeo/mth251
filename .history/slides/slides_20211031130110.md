...
- Space Complexity: by giving the size of the data set as integer N, consider the size of space that need to be allocated by computer before the algorithm can finish  
