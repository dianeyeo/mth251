...
<div class="inline-grid grid-cols-[1fr,3fr] gap-8">
  <div>1. init</div>
  <div><img src="/images/lab/cq1_init.png" style="height: 60"/></div>
  <div>2. enqueue D1</div>
  <div><img src="/images/lab/cq2.png" style="height: 60"/></div>  
  <div>3. enqueue D2, D3, D4 and dequeue D1</div>
  <div><img src="/images/lab/cq3.png" style="height: 60"/></div>
</div>
...
<div class="inline-grid grid-cols-[1fr,3fr] gap-8">
  ...
  <div><img src="/images/lab/cq4.png" style="height: 60"/></div>
  <div>5. dequeue D2, D3, D4, D5 and enqueue D9, D10</div>
  <div><img src="/images/lab/cq5.png" style="height: 60"/></div> 
</div>
...
One of the benefits of the circular queue is that we can make use of the spaces in front of the queue. In a normal queue, once the queue becomes full, we cannot insert the next element even if there is a space in front of the queue (which is bad as it does not prevent the program accidently create a large stack or queue and use up the memory). But using the circular queue, we can use the space to store new values. 
