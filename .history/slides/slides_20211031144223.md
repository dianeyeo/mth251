...
An <span class="hl-bg">abstract data type</span>(ADT) is an abstraction of a `data structure` which provides only the interface to which a data structure must adhere to.
