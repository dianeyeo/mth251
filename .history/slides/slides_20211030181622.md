...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      ...
      <br/>
      <span style="colow:yellow"><i class="far fa-sticky-note"></i> </span=> Also possible to create a new environment via command line: <br/>
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p style="font-size:0.75rem">
      ...
      <br/>
      <span color="yellow"><i class="far fa-sticky-note"></i> </span>
      <br/>
      Notice the Jupyter link in the prompt, you can copy & paste it to your browser 
      <br/> 
