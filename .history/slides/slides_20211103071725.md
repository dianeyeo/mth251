...
Priority Queue is similar to queue but the element with higher priority can be moved forward to the front. Use exiting Queue class to implement a priority queue. 

Element with lower value has higher priority
