...
An <span class="hl-bg"></span>abstract data type`(ADT) is an abstraction of a `data structure` which provides only the interface to which a data structure must adhere to.
