...
<div class="inline-grid grid-cols-[1fr,3fr] gap-8">
  <div>1. init</div>
  <div><img src="/images/lab/cq1_init.png" style="height: 50px"/></div>
  <div>2. enqueue D1</div>
  <div><img src="/images/lab/cq2.png" style="width: 50px"/></div>  
  <div>3. enqueue D2, D3, D4 and dequeue D1</div>
  <div><img src="/images/lab/cq3.png" style="width: 50px"/></div>
</div>
