...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  ...
  <div>
    <p>
        <img src="/images/lab/anaconda_env.png" style="width:50%"/><br/>
        <img src="/images/lab/anaconda_jupyter.png" style="width:50%"/>
    </p>
  </div>  
</div>
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    <p class="norm">
      <i class="far fa-comment-dots"></i> Also possible to perform via command line: <br/>
      ＞ conda create mth251 python=3.8
    </p> 
  </div>
  <div>
    <p><img src="/images/lab/anaconda_cmd.png" style="width:50%"/></p>
  </div>
</div>
