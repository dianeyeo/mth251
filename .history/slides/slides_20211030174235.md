...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  <div>
    ...
    <br/>
    also possible to create a new environment via command line: </p> 
    <p style="font-size:0.75rem; font-family: 'Open Sans'">&gt;conda create mth251 python=3.8</p>
  </div>
  <div>
    <p><img src="/images/lab/anaconda_env.png" style="height:50%"/></p>
  </div>
</div>
...
<div class="inline-grid grid-cols-[1fr,2fr] gap-4">
  ...
  <div>
    <p><img src="/images/lab/anaconda_jupyter.png" style="height:10%"/></p>
  </div>
</div>
