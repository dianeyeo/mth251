...
<!--
Names are identifiers, we use names to track objects - everything in Python is object, class, methods, functions, modules, etc. Namespace is the naming hierarchy to name things in a way without any ambiguity.
