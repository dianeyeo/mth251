...
-   familiar yourself with Python and do exercise <mid-file-code-outline />[lab1.ipynb](https://github.com/fastzhong/mth251/blob/main/notebooks/lab1.ipynb)
...
-   exercise: <span class="hl">lab5.ipynb</span>
...
-   exercise: <span class="hl">lab6.ipynb</span>