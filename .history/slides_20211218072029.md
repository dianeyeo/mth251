...
<div grid="~ cols-4 gap-8">
  ...
  <div><i class="fab fa-youtube"></i> <a href=""></a>Python Tutorial - Python for Beginners [2020]](https://www.youtube.com/watch?v=kqtD5dpn9C8)</div>
</div>

![links](https://github.com/fastzhong/mth251/tree/main/resources)
