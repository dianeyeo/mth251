...
- statement & comments
  ...
  - Python relies on indentation (whitespace sensitive), to define scope; such as the scope of loops, functions and classes. Other programming languages often use {} for this purpose.
- control flow
