...
- statement & comments
  ...
  - Python relies on indentation (whitespace sensitive), to define scope; such as the scope of loops, functions and classes. Other programming languages often use {}
- control flow
    - <kbd>if..elif..else</kbd>
    - <kbd>while</kbd> <kbd>forv</kbd> <kbd>break</kbd> <kbd>continue</kbd> 
- function
- <kbd>import</kbd> (modules & packages)
- error & exception
