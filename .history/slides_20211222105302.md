...
-   statement & comments
  ...
  - Python relies on indentation (<span class="uline">whitespace sensitive</span>), to define scope; such as the scope of loops, functions and classes, as ther programming languages often use <kbd>{}</kbd>
