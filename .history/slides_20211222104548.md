...
- variable
- statement & comments
  - Python uses new lines to complete a command, as opposed to other programming languages which often use ; or ()
  - Python relies on indentation (whitespace sensitive), to define scope; such as the scope of loops, functions and classes. Other programming languages often use curly-brackets for this purpose.
- control flow
    - <kbd>if..elif..else</kbd>
    - <kbd>while</kbd> <kbd>forv</kbd> <kbd>break</kbd> <kbd>continue</kbd> 
- function
