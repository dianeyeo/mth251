...
# [Learning Resource <mdi-code-tags-check />](https://leetcode.com/)
...
-   <span class="hl-color">Procedure</span> vs. <span class="hl-color">OO</span> vs <span class="hl-color">Functional</span>
